...
#args = c("../../bwa","total,primary_gg7b,unique_gg7b","../../samples.tsv","Sample,Cell_stage,Type,Protein")
...
df<-as.data.frame(k[filters],stringsAsFactors = F) %>% rownames_to_column("Sample") %>% 
...
#Create DT
dt2<-DT::datatable(s2,options = list(pageLength=50)) %>% formatRound(names(t2)[-1])
